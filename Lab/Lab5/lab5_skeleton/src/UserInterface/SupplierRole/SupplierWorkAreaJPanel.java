...
//       masterOrderCatalog = moc;
    ...
    private void initComponents() {
        ...
        managePButton.setFont(new java.awt.Font("Tahoma", 3, 14)); // NOI18N
        ...
        add(managePButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 110, 260, -1));
        ...
        reportButton4.setFont(new java.awt.Font("Tahoma", 3, 14)); // NOI18N
    ...
    private void reportButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_reportButton4ActionPerformed
        ...
        userProcessContainer.add("ProductReportJPanelSupplier", productSalesReviewJPanel);
        CardLayout layout = (CardLayout)userProcessContainer.getLayout();
        layout.next(userProcessContainer);
