...
public class BrowseProductJPanel extends javax.swing.JPanel {
     ...
     */
    public BrowseProductJPanel(JPanel userProcessContainer,MasterOrderCatalog masterOrderCatalog,SupplierDirectory supplierDirectory) {
        initComponents();
        ...
        supplierComboBox.addItem("All Supplier");
    ...
    private void refreshOrderItemTable(){
        ...
        if (null != supplierDirectory.getSupplierList()){
           for (OrderItem orderItem : order.getOrderItemList() ){
               ...
               rows[3] = (Integer.parseInt(orderItem.getProduct().getPrice()) * orderItem.getQuantity());
               defaultTableModel.addRow(rows);
               }
           }
    }
    ...
    private void searchSupplierButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchSupplierButtonActionPerformed
        ...
        if (null == keyWord || "".equals(keyWord)){
             ...
             supplier = supplierDirectory.searchSupplier(keyWord);
    ...
    private void addToCartButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addToCartButtonActionPerformed
        ...
        if (selectedRow < 0 ){
            ...
            if (quantity > product.getAvailable()) {
                JOptionPane.showMessageDialog(null, "The desired value ");
                return;
            }
