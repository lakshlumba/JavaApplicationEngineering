...
public class ManageUserAccountDirectoryJPanel extends javax.swing.JPanel {
   ...
   private final JPanel userProcessContainer;
    ...
    private void populateEmployeeCombo(){
        ...
        if (null != organization){
            for (Employee employee : organization.getEmployeeDirectory().getEmployeeList())
                    employeeNameComboBox.addItem(employee);
        }
    }
    ...
    private void createButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createButtonActionPerformed
        Organization organization = (Organization)orgComboBox.getSelectedItem();
        Employee employee = (Employee)employeeNameComboBox.getSelectedItem();
        Role role = (Role)roleComboBox.getSelectedItem();
        organization.getUserAccountDirectory().createUserAccount(userTextField.getText(), passTextField.getText(), employee, role);
        populateUserTable();
