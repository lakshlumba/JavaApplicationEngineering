...
public class LabAssistantWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void populateTable(){
        ...
        for (WorkRequest workRequest : labOrganization.getWorkQueue().getWorkRequestList()){
            ...
            row[2] = workRequest.getReceiver() == null ? null : workRequest.getReceiver().getEmployee().getName();
    ...
    private void processJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processJButtonActionPerformed
        ...
        ProcessWorkRequestJPanel processWorkRequestJPanel = new ProcessWorkRequestJPanel(userProcessContainer, labTestWorkRequest);
