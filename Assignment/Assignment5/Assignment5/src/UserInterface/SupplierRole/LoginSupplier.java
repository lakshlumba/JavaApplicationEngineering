...
//    MasterOrderCatalog masterOrderCatalog;
    ...
    public LoginSupplier(JPanel userProcessContainer, SupplierDirectory supplierDirectory) {
       ...
       populateSuppplierList();
    }
    private void populateSuppplierList(){
    ...
    private void initComponents() {
        ...
        findButton1.setFont(new java.awt.Font("Tahoma", 3, 14)); // NOI18N
        ...
        add(findButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 130, -1, 20));

        jLabel2.setFont(new java.awt.Font("Tahoma", 3, 18)); // NOI18N
        jLabel2.setText("Supplier Login");
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 50, -1, -1));

        supplierComboBox1.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        ...
        add(supplierComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 130, 150, -1));
